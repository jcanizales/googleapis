...
mkdir -p gapic/api
cat > gapic/api/artman_${API_NAME}.yaml << EOF
common:
...
echo "Dependencies need to be added manually."
echo "Also check if there's going to be Ruby or Node veneers for this API, in"
echo "which case you have to remove their 'skip_packman: True' lines."
